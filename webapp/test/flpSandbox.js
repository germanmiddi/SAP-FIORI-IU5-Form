			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FormFIORI-display": {
								"semanticObject": "FormFIORI",
								"action": "display",
								"description": "Report FIORI",
								"title": "Form FIORI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.front",
									"url": sap.ui.require.toUrl("logaligroup/front")
								}
							}
						}
					}
